# simplify-git-installation - Task 17

Execute task 17 for the simplify-git-installation specification.

## Task Description
Create project initialization command in cli/src/commands/init.ts

## Code Reuse
**Leverage existing code**: existing templates, zero-config patterns
...
```
Use the spec-task-executor agent to implement task 17: "Create project initialization command in cli/src/commands/init.ts" for the simplify-git-installation specification.
...
3. Implement ONLY task 17: "Create project initialization command in cli/src/commands/init.ts"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks simplify-git-installation 17 --mode single
...
Task details:
- ID: 17
- Description: Create project initialization command in cli/src/commands/init.ts
- Leverage: existing templates, zero-config patterns
- Requirements: 4.4
```

**Fallback Execution**: If the agent is not available, you can execute:
```
/spec-execute 17 simplify-git-installation
```
...
2. Execute task 17: "Create project initialization command in cli/src/commands/init.ts"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks simplify-git-installation 17 --mode complete
   ```
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 17 for the simplify-git-installation specification.
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 17 of the simplify-git-installation specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 17 for the simplify-git-installation specification.
