# simplify-git-installation - Task 20

Execute task 20 for the simplify-git-installation specification.

## Task Description
Update main README.md with installation decision tree
...
```
Use the spec-task-executor agent to implement task 20: "Update main README.md with installation decision tree" for the simplify-git-installation specification.
...
3. Implement ONLY task 20: "Update main README.md with installation decision tree"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks simplify-git-installation 20 --mode single
...
Task details:
- ID: 20
- Description: Update main README.md with installation decision tree
...
```
/spec-execute 20 simplify-git-installation
```
...
2. Execute task 20: "Update main README.md with installation decision tree"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks simplify-git-installation 20 --mode complete
   ```
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 20 for the simplify-git-installation specification.
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 20 of the simplify-git-installation specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 20 for the simplify-git-installation specification.
