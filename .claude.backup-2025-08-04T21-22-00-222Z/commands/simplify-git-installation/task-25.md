# simplify-git-installation - Task 25

Execute task 25 for the simplify-git-installation specification.

## Task Description
Update CI workflows to test installation methods in .github/workflows/test-installation.yml

## Code Reuse
**Leverage existing code**: existing CI workflows

## Requirements Reference
**Requirements**: 1.4, All requirements
...
```
Use the spec-task-executor agent to implement task 25: "Update CI workflows to test installation methods in .github/workflows/test-installation.yml" for the simplify-git-installation specification.

The agent should:
1. Load all specification context from .claude/specs/simplify-git-installation/
2. Load steering documents from .claude/steering/ (if available)
3. Implement ONLY task 25: "Update CI workflows to test installation methods in .github/workflows/test-installation.yml"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks simplify-git-installation 25 --mode single

# Load context documents
# Windows:
npx @pimzino/claude-code-spec-workflow@latest get-content "C:\path\to\project\.claude\specs\simplify-git-installation\requirements.md"
npx @pimzino/claude-code-spec-workflow@latest get-content "C:\path\to\project\.claude\specs\simplify-git-installation\design.md"

# macOS/Linux:
npx @pimzino/claude-code-spec-workflow@latest get-content "/path/to/project/.claude/specs/simplify-git-installation/requirements.md"
npx @pimzino/claude-code-spec-workflow@latest get-content "/path/to/project/.claude/specs/simplify-git-installation/design.md"
...
Task details:
- ID: 25
- Description: Update CI workflows to test installation methods in .github/workflows/test-installation.yml
- Leverage: existing CI workflows
- Requirements: 1.4, All requirements
```

**Fallback Execution**: If the agent is not available, you can execute:
```
/spec-execute 25 simplify-git-installation
```
...
# Windows: npx @pimzino/claude-code-spec-workflow@latest get-content "C:\path\to\project\.claude\specs\simplify-git-installation\requirements.md"
# macOS/Linux: npx @pimzino/claude-code-spec-workflow@latest get-content "/path/to/project/.claude/specs/simplify-git-installation/requirements.md"

# Design document:
# Windows: npx @pimzino/claude-code-spec-workflow@latest get-content "C:\path\to\project\.claude\specs\simplify-git-installation\design.md"
# macOS/Linux: npx @pimzino/claude-code-spec-workflow@latest get-content "/path/to/project/.claude/specs/simplify-git-installation/design.md"
...
2. Execute task 25: "Update CI workflows to test installation methods in .github/workflows/test-installation.yml"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks simplify-git-installation 25 --mode complete
   ```
2. **Confirm to user**: State clearly "Task 25 has been marked as complete"
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 25 for the simplify-git-installation specification.
...
- Specific task 25 details via get-tasks
- All implementation changes for task 25
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 25 of the simplify-git-installation specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 25 for the simplify-git-installation specification.
...
- Execute the next task using /simplify-git-installation-task-[next-id]
- Check overall progress with /spec-status simplify-git-installation
- If all tasks complete, run /spec-completion-review simplify-git-installation
