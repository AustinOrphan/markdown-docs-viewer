...
export enum OptimizationErrorType {
  ...
  // Additional error types for production error handling
  CONFIG_DISCOVERY_FAILED = 'CONFIG_DISCOVERY_FAILED',
  DOCUMENT_DISCOVERY_FAILED = 'DOCUMENT_DISCOVERY_FAILED',
  REQUEST_POOL_EXHAUSTED = 'REQUEST_POOL_EXHAUSTED',
  CACHE_CORRUPTION = 'CACHE_CORRUPTION',
  ENVIRONMENT_DETECTION_FAILED = 'ENVIRONMENT_DETECTION_FAILED',
  ADAPTER_FAILED = 'ADAPTER_FAILED',
  MANIFEST_PARSING_FAILED = 'MANIFEST_PARSING_FAILED',
