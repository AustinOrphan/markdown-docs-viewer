...
describe.skip('SearchManager', () => {
  ...
  afterEach(() => {
    // Safely remove container if it exists and is still in document
  ...
  describe('Keyboard navigation', () => {
    ...
    it('should select result on Enter key', () => {
      ...
      searchManager.setDocuments([{ id: 'doc1', title: 'Doc 1' }]);
  ...
  describe('Search results rendering', () => {
    ...
    it('should highlight search query in results', async () => {
      const searchResults: Document[] = [{ id: 'doc1', title: 'Test Document' }];
      mockSearchIndex.search.mockReturnValue(searchResults);
